...
const dmx = Math.max(...Índice);
const dm = Math.min(...Índice);
console.log ("O dia, em junho, que mais choveu foi(foram) o(os) dia(dias) em que choveu(choveram) " + dmx + " mm.");
console.log ("E o dia, em junho, que menos choveu foi(foram) o(os) dia(dias) em que choveu(choveram) " + dm + " mm.");
